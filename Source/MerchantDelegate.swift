...
public protocol MerchantDelegate : AnyObject {
    ...
    /// Called when the `isLoading` property on the `Merchant` changes. You may want to update UI in response to loading state changes, or you may want to do nothing. The default implementation of this delegate method does nothing.
